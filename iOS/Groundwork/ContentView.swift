...
struct ContentView: View {
    ...
    @State private var newValue: Double = 20.0
    @AppStorage("targetValue") private var targetValue: Double = 20.0
        ...
        NavigationStack {
            List {
                Section {
                    ...
                    Stepper("Daily Goal (min): \(String(format: "%.1f", targetValue))", value: $targetValue, in: 0...48, step: 0.5)
            ...
            .sheet(isPresented: $showAddSheet) {
                NavigationStack {
                    Form {
                        Stepper("Minutes Barefoot: \(String(format: "%.1f", newValue))", value: $newValue, in: 0...24, step: 0.25)
